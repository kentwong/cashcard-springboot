...
// ensures that the Spring context is reset after each test method.
...
class CashCardApplicationTests {
	...
	@Test
	@DirtiesContext
	// Please note that using @DirtiesContext can slow down your tests because
	// resetting the Spring context is an expensive operation.
	...
	void shouldReturnASortedPageOfCashCards() {
		// Can change the sorting order from desc to asc.
